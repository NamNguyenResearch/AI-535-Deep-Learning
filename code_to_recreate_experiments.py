...
settings = []
experiment_number = ("M3")  # This is the folder which will be created to contain the results
...
Lambda_base = [0, 0.001, 0.0033, 0.0066, 0.008, 0.011, 0.013, 0.015]  # Tradeoff points
...
Lambda_reduced = [0, 0.001, 0.0033, 0.0066, 0.008, 0.011, 0.013, 0.015] # Tradeoff points
    ...
    settings.append(
        {
            ...
            "n_epochs": 25,
            "progress_intervals": 6,
            "initialize_base_discriminator": 1,
            "initialize_mse_model": 0,
            "test_batch_size": 100,
        }
    )
